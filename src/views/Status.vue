<template>
    <n-card>
        <n-space vertical :size="15">
            <n-grid :col="24" x-gap="0 800:20" class="status-header" item-responsive>
                <n-grid-item span="12 800:4">
                    <n-h2 style="margin: 0px;">评测列表</n-h2>
                </n-grid-item>
                <n-grid-item offset="12" span="0 800:8" class="status-header-right">
                    <n-space :size="20" style="display: flex; align-items: center;">
                        ...
                        <search-box haveTextSelector></search-box>
                    </n-space>
                </n-grid-item>
            </n-grid>
